...
public class FxController extends Application {
	...
	/**
	 * Adapte the mouse click for screen and number cards
	 * @param e
	 * @return
	 */
	...
	private GridPane deckOfCards() {
		...
		// Load the image
		Image image = new Image("./images/tarotcards.jpg");
